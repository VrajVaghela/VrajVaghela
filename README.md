...
<!--
  Rendered by .github/workflows/metrics.yml into this repo, NOT fetched from
  github-readme-stats.vercel.app (currently 503 DEPLOYMENT_PAUSED).
  Appears after the first Actions run. Needs METRICS_TOKEN — see SETUP.md.
-->
<img src="./.github/assets/metrics-overview.svg" alt="GitHub activity overview — generated by GitHub Actions" width="100%" />
